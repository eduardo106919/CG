...
void prepareCilinder(float height, float radius, int sides)
{
	...
	{
		float s0 = sin(i * delta);
		float c0 = cos(i * delta);
		float s1 = sin((i + 1) * delta);
		float c1 = cos((i + 1) * delta);
		...
		vertex++;
		v[vertex * 3 + 0] = radius * s0;
		v[vertex * 3 + 1] = height / 2.0f;
		v[vertex * 3 + 2] = radius * c0;
		n[vertex * 3 + 0] = 0.0f;
		n[vertex * 3 + 1] = 1.0f;
		n[vertex * 3 + 2] = 0.0f;

		vertex++;
		v[vertex * 3 + 0] = radius * s1;
		v[vertex * 3 + 1] = height / 2.0f;
		v[vertex * 3 + 2] = radius * c1;
		n[vertex * 3 + 0] = 0.0f;
		n[vertex * 3 + 1] = 1.0f;
		n[vertex * 3 + 2] = 0.0f;
